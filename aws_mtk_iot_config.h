...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "AYL9A14ZPVEKQ.iot.us-east-1.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "prat123" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 	       "dumble-door" //IMPORTANT: for a temporary work around, you also need to modify the same name in your library for aws_iot_config.h (under arduino library path)
...
#define WIFI_AP "Thor"
#define WIFI_PASSWORD "connectMe1"
